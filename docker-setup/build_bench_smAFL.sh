...
function build_with_smAFL() {
    CC="/fuzzer/smAFL/afl-clang-fast"
    CXX="/fuzzer/smAFL/afl-clang-fast++"
    ...
    for BUG_NAME in "${str_array[@]:1}"; do
        ...
        cp /benchmark/target/stack-trace/$BIN_NAME/$BUG_NAME-sm $TMP_DIR/BBtargets.txt
        ...
        /fuzzer/smAFL/scripts/genDistance.sh $PWD $TMP_DIR $BIN_NAME
        ...
        ### copy results
        copy_build_result $1 $BIN_NAME $BUG_NAME $STR_TYPE "smAFL"
        rm -rf /benchmark/RUNDIR-$1
...
build_with_smAFL "binutils-2.26" "strstr" \
    "cxxfilt 2016-4487 2016-4489 2016-4490 2016-4492"

build_with_smAFL "binutils-2.26" "atoi" \
    "cxxfilt 2016-4487 2016-4489 2016-4490 2016-4492"
